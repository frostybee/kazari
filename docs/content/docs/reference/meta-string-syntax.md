...
> [!NOTE]
> Static site generators discard this text before HTML exists. Sites handed to the [HTML Processor](/cli/overview/) need a per-block [render hook](/cli/render-hooks/) for meta string features to survive the build.
